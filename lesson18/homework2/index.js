...
console.log('#1 ', sumWithMemory.callsHistory); // ===> [ [4, 2], [9, 1] ]
...
console.log('#2 ', addDeltaWithMemory.callsHistory); // ===> [ [[111, 22, 55, 4], 8], [[9, 1, -8, 15, 7, 0], 7] ]
...
console.log('#3 ', sayHiWithMemory.callsHistory); // [ [] ]

// function saveFuncCalls(func) {
//   let calls = [];

//   let memoryFunc = function withMemory(...args) {
//     func.apply(this, args);
//     calls.push(args);

//     return func.apply(this, args);
//   };
//   memoryFunc.callsHistory = calls;
